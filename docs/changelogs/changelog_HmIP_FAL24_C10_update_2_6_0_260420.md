## [HmIP_FAL24_C10_update_2_6_0_260420.tgz](https://raw.githubusercontent.com/OpenCCU/HMDeviceFirmware/master/HmIP/HmIP_FAL24_C10_update_2_6_0_260420.tgz)
Required CCU firmware version: &#8805; 3.73.4<br/>
<sub>sha256: bc5f694d340410d4c105d6e779856aa9e29af131a6e28f2a258affe6e1c41110</sub>
...
** Improvement
   * Evaluation of heating/cooling in the Heating Controller Mode frame to ensure
	 consistency in the system.
	  If the device detects an inconsistency between heating/cooling with the wall
	  thermostat, the mode in the wall thermostat is overwritten by the device.
   * Heat demand stays OFF after reboot of the IO box
	  To allow the heat demand control to resynchronize after a reboot of the MIOB or
	  WHS2, a Conditional Switch Command with a value of 200 is sent at the start of
	  the PWM cycle time (default 15 minutes).
