## [HmIP-HAP2-A_1_0_48_251202.tgz](https://raw.githubusercontent.com/OpenCCU/HMDeviceFirmware/master/HmIP/HmIP-HAP2-A_1_0_48_251202.tgz)
Required CCU firmware version: &#8805; 3.83.6<br/>
<sub>sha256: 551a0254e655ab8c2ca31c727836933eb9793cc24860c346fec32e13cc8eb325</sub>
...
Version 1.0.48 - 2025-12-02
--------------------------------------------------------------

** Bugfix
   * Inclusion confirmation over websocket is send with jd address



Version 1.0.46 - 2025-11-14
--------------------------------------------------------------

** Bugfix
   * Wrong Route Entry after flooding
   * Close connection with 10s leads to error
   * Close from crrfd with reason 4000 not work

** Improvement
   * Update cJSON library to version 1.7.19
   * Use NTP to get the Time after Reboot
