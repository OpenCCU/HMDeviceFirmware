## [HmIP-FSM16_update_V1_28_0_250423.tgz](https://raw.githubusercontent.com/OpenCCU/HMDeviceFirmware/master/HmIP/HmIP-FSM16_update_V1_28_0_250423.tgz)
Required CCU firmware version: &#8805; 3.69.6<br/>
<sub>sha256: c24e70311fbe6e5741eae8c4680aeba3ba5d58c27580f27dd0755fbcdb87a288</sub>
...
Version 1 (2 for pluggable).28.0 - 2025-04-23
--------------------------------------------------------------
** Bugfix
   * Switching action in two-point control does not work reliably
   * Wrong evaluation of the event counter with multiple links between sensor and actuator

** New Feature
   * Add support for ELV-SH-PSMCI
   
** Modification
   * Update Bootloader to 1.16.0 (EFM32G210F128 based devices)
   * Update HMOS to 1.90.0

Version 1 (2 for pluggable).26.22 - 2024-09-24
--------------------------------------------------------------
** Bugfix
   * Input parameter double click time is not used (only HmIP-PS(M)/HmIP-PS(M)-2/HmIP-PSMCO)
   * First button press duration at factory reset to small (HmIP-PSMCO)
   
Version 1 (2 for pluggable).26.20 - 2023-09-20
--------------------------------------------------------------
** Bugfix
   * Activate power failure detection for plugable switches (HmIP-PS(M)(-2))
** New Feature
   * Add support for HmIP-PSMCO
   * bidirectional Energymeter Status added (for HmIP-PSMCO only)   

Version 1 (2 for pluggable).24.8 - 2024-03-05
--------------------------------------------------------------
** Bugfix
   * Fixed incorrect internal oscillator calibration (only HmIP-PS(M)/HmIP-PS(M)-2)
   * Corrected error in the temperature measuring function (only HmIP-PSM-2 QHJ and HmIP-PS-2 9YM)
...
** Comments 
   ...
   * First release version for ELV-SH-SB8
