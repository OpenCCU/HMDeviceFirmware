## [HmIP-DRG-DALI_update_V1_8_4_260616.tgz](https://raw.githubusercontent.com/OpenCCU/HMDeviceFirmware/master/HmIP/HmIP-DRG-DALI_update_V1_8_4_260616.tgz)
Required CCU firmware version: &#8805; 3.89.8<br/>
<sub>sha256: 101b1937536fec0fb7b2ebd325fe32a36c825b7922004a5d54ee4e9f5cc8a64e</sub>
...
Version 1.8.4 - 2026-06-16
--------------------------------------------------------------

** Bugfix
   * Sends a request for a known route
   * Use a route with distance 7
   * Routes answer to wrong Router
   * Netfinder 3.x errors
   * Powerup On/Of TC with HCL and Dim2Warm
   * Statusinfo to systempartner 0xf00007 only for channel 1 to 6
   * No status info after reboot
   * DEC Identify with KeyVisual does not use the on time



Version 1.8.2 - 2026-03-27
--------------------------------------------------------------
...
Version 1.8.0 - 2026-03-25
--------------------------------------------------------------

** Bugfix
   * Dim after long press
   * ETH: RX hangs if too many frames are received very quickly
   * POWERUP_ON/OFF_TC is not used correctly
   * No frame at link up
   * Not send dec identify at press system button
   * ReportConfigChange is send for channel 0 list 0 at learn dali devices
   * Effect 1 (Campfire) and Effect 5 (Waterfall) are set in parameters
   * Saturation in effect 4 colour 3 wrong
   * Device makes inexplicably many Backbone_Sequence_Number_Validations
   * Routes are not marked as unreachable if the responsible router is detected as offline.

** New Feature
   * Add WP_AUTO_RESTORE_CHANNELS_1 .. WP_AUTO_RESTORE_CHANNELS_6



Version 1.6.4 - 2025-10-02
--------------------------------------------------------------
