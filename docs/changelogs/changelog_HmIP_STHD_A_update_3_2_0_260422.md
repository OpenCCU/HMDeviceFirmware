## [HmIP_STHD_A_update_3_2_0_260422.tgz](https://raw.githubusercontent.com/OpenCCU/HMDeviceFirmware/master/HmIP/HmIP_STHD_A_update_3_2_0_260422.tgz)
Required CCU firmware version: &#8805; 3.81.5<br/>
<sub>sha256: 653e081234c7258f32e40d79cf4be343cbde038a0e1e6f11b76afa260148dac8</sub>
...
Device: HmIP-STHD-A - Homematic IP Temperature and Humidity Sensor with display - indoor

Company: eQ-3, Maiburger Str. 29, 26789 Leer, Germany


Version 3.2.0 - 2026-04-20
--------------------------------------------------------------
Version
  Application:      3.2.0
  Bootloader:       1.14.0
  BootloaderWired:  1.6.0
  Library:          1.94.0

** Bugfix
   * In connection with a switching actuator, the device sends target level 0 in the
     "On" state (30.5).
   * After a communication fault between the wall thermostat and FAL has been rectified,
     the antenna symbol was continues flashing.
   * The hygrostat mode (2-point control with actuator) was operates in cooling mode
	 inverted.
   * The antenna symbol continued to flash even though radio communication with the
     floor heating controller had been restored.

** Inprovement
   * Extension of the Heating Controller Mode frame to include the information
	 Heating/Cooling.
	 If a communication failure prevents the wall thermostat from being informed about a
	 heating/cooling mode change, the floor heating controller can use the additional
	 information in the Heating Controller Mode frame to check whether the devices are
	 synchronized in terms of mode. If not, the floor heating controller will inform the
	 wall thermostat again.
